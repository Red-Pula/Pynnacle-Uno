...
class _Style:
    ...
    def info():
        ...
        formatted_text = (
            ...
            f"{_Style.__COLOR_BLUE}{_Style.__BOLD}By:{_Style.__RESET} {_Style.__COLOR_BLUE}{_Style.__UNDERLINE}Red Hizon{_Style.__RESET}, {_Style.__COLOR_BLUE}{_Style.__UNDERLINE}Jenel Justo{_Style.__RESET}, {_Style.__COLOR_BLUE}{_Style.__UNDERLINE}Serena Lee\n{_Style.__RESET}"
        )
